...
async execute(client, message, args){
     setTimeout(function() {
          ...
          console.log(chalk.cyan(`\n[ BATNET ] ${message.author.tag} Has executed the invite command`));
          ...
          message.channel.send({
               embed: {
                    description: `${emojis.bat} **| [Click here](https://discord.com/oauth2/authorize?scope=bot&client_id=1072650360965042366&permissions=8) to invite BatNet to a guild.`,
                    author: {
                              name: 'Invite',
                              url: 'https://discord.gg/DeathTeam',
                              icon_url: 'https://cdn.discordapp.com/emojis/1091519096291590174.gif?v=1&size=48&quality=lossless'
